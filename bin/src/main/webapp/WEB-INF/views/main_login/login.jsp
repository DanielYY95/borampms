                        ...
                        <div class="card">
                            ...
                            <div class="card-body p-4">
                                ...
                                <form method="post" action="${path}/login.do?method=session">
                                    ...
                                    <div class="mb-3">
                                        <a href="pages-recoverpw.html" class="text-muted float-end"><small>비밀번호 찾기</small></a>
		...
		$(document).ready(function(){
			...
			if(loginMsg!=""){
				...
				if(loginMsg=="로그인 성공!"){ // 로그인 성공을 보여주고나서 이동
					location.href="${path}/project/schedule/schCalendar.html"; // 원래라면 요청이 들어온 곳으로 보내고 싶은데, mapping url은...
				}
			}
