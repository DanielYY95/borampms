	...
	<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
		<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
			...
			<%-- --%>
				...
				<!-- 참고사이트: http://egloos.zum.com/parandiary/v/3020211-->
				...
				<body class="loading" data-layout-color="light" data-leftbar-theme="dark" data-layout-mode="fluid"
					...
					<!-- JSON 데이터 -->
						<script>
							...
							console.log("2022-01-05".substring(0,4));
							...
							function getData(){
								...
								$.ajax({
									...
									success:function(data){
										...
										$.each(data.ganttList, function(idx, sch){
											dataList += "{ id:"+sch.ptId+", text:'"+ sch.ptTitle+"', start_date: '"
											+sch.ptStartdate+"', duration:'"+(calDay(sch.ptDueDate-sch.ptStartdate)+1)+"'},"
							...
							function calDay(firstDate, secondDate){
								var dateFirstDate = new Date(firstDate.substring(0, 4), firstDate.substring(5, 7) - 1, firstDate.substring(8, 10));
								var dateSecondDate =
									new Date(secondDate.substring(0, 4), secondDate.substring(5, 7) - 1, secondDate.substring(8, 10));
								var betweenTime = Math.abs(dateSecondDate.getTime() - dateFirstDate.getTime()); 
