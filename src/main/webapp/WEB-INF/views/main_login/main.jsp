                ...
                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                    ...
                    <ul class="navbar-nav ms-auto align-items-center">
                        <li class="nav-item me-0">
                            <a href="login.html" target="_blank" class="nav-link d-lg-none">로그인</a>
                            <a href="login.html" target="_blank" class="btn btn-sm btn-light rounded-pill d-none d-lg-inline-flex"><!-- 버튼같은 a태그 -->
                                <span style="padding-top: 3%;">로그인&nbsp;</span> <i class="dripicons-power" > </i>
                            </a> <!-- 두 개가 있는 이유가 뭐지??? 아... 반응형!!-->
                        </li>
                    </ul>
                ...
                <div class="row align-items-center">
                    <div class="col-md-5">
                        <div class="mt-md-4">
                            ...
                            <a href="reg.html" target="_blank" class="btn btn-success">시작하기 <i
